                ...
                <motion.div initial="hidden" animate="visible" variants={{
                    ...
                    <div className="flex  flex-col items-center mx-auto ">
                        <form name="contactus" method="POST" data-netlify="true" className="  flex  flex-col items-center  "   >
                            ...
                            <input name="cname" type="text" className="w-full text-3xl h-12  text-black  mt-2 p-2 focus:outline-none focus:shadow-outline  border-2 border-black"
                                required />
                            ...
                            <input name="cemail" type="email" className="w-full text-3xl   h-12 text-black  mt-2 p-2  focus:outline-none focus:shadow-outline  border-2 border-black"
                                required />
                            ...
                            <textarea name="cmessage"
                                className="w-full text-3xl h-28   text-black  mt-2 p-2  focus:outline-none focus:shadow-outline   border-2 border-black" required></textarea>
