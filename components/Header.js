            ...
            <nav className='  flex items-center flex-wrap px-12  shadow-xl rounded-3xl h-12 bg-gallery-50 dark:bg-ebony-clay-600	'>
                <Link href='/'>
                    <a className='inline-flex items-center p-2 mr-4  '>
                        ...
                        <h1 className="text-center text-black dark:text-bright-gray-50 ">Vector Hamza</h1>
                    </a>
                </Link>
                ...
                >
                    <motion.div whileInView={{ scale: 1.2 }} transition={{ duration: .2 }} whileTap={{ scale: .9 }} className='lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto text-center bg-gallery-50 dark:bg-ebony-clay-600 rounded-xl shadow-xl lg:shadow-none mt-5 lg:mt-0'>
                        <Link href='/'>
