                ...
                <div className="container px-5 py-12 mx-auto text-black dark:text-bright-gray-50">
                    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                        ...
                        <p className="leading-relaxed text-lg">Welcome to anyone who found this website
                            My name is Hamza I am from Morocco, graphic designer, digital drawing artist ( cover book , personal portrait...). Here you can see all my artwork and refill you insperation.
                        </p>
